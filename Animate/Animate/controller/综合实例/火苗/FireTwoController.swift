...
class FireTwoController: UIViewController {
...
//        cell.color = UIColor(red: 200 / 255.0, green: 87 / 255.0, blue: 14 / 255.0, alpha: 0.1).cgColor
    ...
    lazy var fireEmitter : CAEmitterLayer = {
        ...
        //设置中心点
//        emitter.emitterPosition = CGPoint(x: self.fireImageView.frame.width * 0.6, y: self.fireImageView.frame.height * 0.4)
        
        emitter.emitterPosition = CGPoint(x: self.fireImageView.center.x + 10, y: self.fireImageView.center.y - 10)
